...
import type { FormData, Story } from "./components/types.ts";
              ...
              if (data.type === "videoId") {
                ...
                if (typeof data.data === "string") {
                  ...
                  if (fileData.filename.endsWith(".webp")) {
                    ...
                    const currentVideoId = fileData.video_id || data.videoId ||
                      videoId;
                    ...
                    const imageUrl = `${
                      formData.apiUrl || VIDEO_SERVICE_URL
                    }/segments/${currentVideoId}/${fileData.filename}`;
