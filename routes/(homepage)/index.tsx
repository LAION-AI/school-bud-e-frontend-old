...
export default function Home(ctx: FreshContext) {
  ...
  return (
    <div class="min-h-screen bg-gradient-to-b from-primary-50 to-white w-full">
            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div class="sm:text-center lg:text-left">
                ...
                <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start gap-4">
                  ...
                  <Button href="/press" variant="primary">
      ...
      {/* CTA Section */}
      <div class="bg-primary-700 text-white border-b">
        <div class="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          <h2 class="text-3xl font-extrabold sm:text-4xl">
            <span class="block">
              {lang === "de" ? "Bereit zum Starten?" : "Ready to get started?"}
            </span>
            <span class="block">
              {lang === "de"
                ? "Beginne noch heute mit School Bud-E."
                : "Begin your journey with School Bud-E today."}
            </span>
          </h2>
