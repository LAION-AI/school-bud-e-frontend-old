...
import ChatModeSelector, { type ChatMode, type SearchSubMode, CHAT_MODES, SEARCH_SUBMODES } from "./ChatModeSelector.tsx";
...
export default function ChatInput() {
    ...
    const getCurrentModePlaceholder = () => {
        ...
        const currentSubMode = currentModeHasSubmodes.value ? selectedSubMode.value : undefined;
    ...
    return (
        <>
            <div class="max-w-xl w-full mx-auto relative">
                ...
                <div className="flex cursor-text flex-col rounded-xl border border-gray-300 px-4 py-2 shadow-[0_2px_6px_rgba(0,0,0,0.1)] transition-colors bg-white mx-4 mb-4" data-tour="chat-input">
                    ...
                    <div class="flex items-center justify-between w-full border-t pt-2">
                        <div class="flex items-center space-x-2">
                                ...
                                <VoiceRecordButton
                                    ...
                                    onInterimTranscript={(interimTranscript) => { query.value = `${query.value} ${interimTranscript}`; }}
