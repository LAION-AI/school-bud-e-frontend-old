    ...
    const loadData = async () => {
      try {
        ...
        const dummyData: TokenUsageStats = {
          ...
          totalOutput: 35672,
          history: [
            { id: "1", date: "2023-06-01", model: "gemini-2.5-flash-preview-04-17", input: 1245, output: 3567 },
            { id: "2", date: "2023-06-02", model: "gemini-2.5-flash-preview-04-17", input: 2356, output: 4789 },
