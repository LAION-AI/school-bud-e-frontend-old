          ...
          <div class="bg-primary-50 box-border border-2 border-primary-300 rounded-lg p-2">
            ...
            >
              ...
              <g filter="url(#filter0_d_25_349)">
                <path
                  d="M28 4.66669C40.887 4.66669 51.3333 15.113 51.3333 28C51.3333 40.887 40.887 51.3334 28 51.3334H9.33329C8.09562 51.3334 6.90863 50.8417 6.03346 49.9665C5.15829 49.0914 4.66663 47.9044 4.66663 46.6667V28C4.66663 15.113 15.113 4.66669 28 4.66669Z"
                  fill="#FEC905"
                />
              </g>
              <mask
              ...
              <g mask="url(#mask0_25_349)">
                <rect
                  ...
                  width="14.3521"
                  height="71"
                  transform="rotate(54.5798 46.8596 0)"
                  fill="white"
                />
                <rect
                  opacity="0.3"
              ...
              <defs>
                ...
                >
                  ...
                  <feColorMatrix
                    type="matrix"
                    values="0 0 0 0 0.560784 0 0 0 0 0.309804 0 0 0 0 0.266667 0 0 0 1 0"
                  />
                  <feBlend
                    mode="normal"
                    in2="BackgroundImageFix"
                    result="effect1_dropShadow_25_349"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_25_349"
                    result="shape"
                  />
                </filter>
              </defs>
