...
import SyncManagerIsland from "./SyncManagerIsland.tsx";
import { Button } from "../components/Button.tsx";

interface SyncJoinFormIslandProps {
  initialRoomName?: string;
  initialUserName?: string;
}

export default function SyncJoinFormIsland({ initialRoomName = '', initialUserName = '' }: SyncJoinFormIslandProps) {
  ...
  return showConfig ? (
    ...
    <div class="py-6">
      <SyncManagerIsland roomName={roomName} userName={userName || undefined} />
