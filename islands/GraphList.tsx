  ...
  if (!isClient.value || isLoading) {
    return (
      <div class="container mx-auto px-6 py-8 max-w-4xl">
        ...
        {[...Array(3)].map((_, index) => (
          <div key={`skeleton-${index}`} class="animate-pulse border border-gray-100 rounded-md p-4 mb-3">
    ...
    <div class="container mx-auto px-6 py-8 max-w-4xl">
      ...
      {graphEntries.length > 0 ? (
              ...
              <div class="flex-1 min-w-0 mr-4">
                ...
                <div class="flex flex-wrap items-center gap-x-4 text-xs text-gray-500 mt-1">
                  <div class="flex items-center" title="Nodes">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 mr-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-labelledby="nodesIconTitle">
                  ...
                  <div class="flex items-center" title="Connections">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 mr-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-labelledby="connectionsIconTitle">
                      <title id="connectionsIconTitle">Connections icon</title>
        ...
        <div class="text-center py-8 border border-dashed border-gray-300 rounded-lg">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mx-auto text-gray-400 mb-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-labelledby="emptyGraphIconTitle">
