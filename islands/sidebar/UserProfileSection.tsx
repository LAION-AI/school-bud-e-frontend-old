	...
	return (
		<div class="border-t pt-2 flex items-center gap-2">
			...
			<button
				...
				class={`p-2 rounded hover:bg-primary-100 transition-colors flex items-center ${isSpeaking ? "text-green-600" : "text-gray-400"}`}
				aria-label={isSpeaking ? "Mute (disable speech)" : "Speak (enable speech)"}
