...
\`\`\``,
    description:
      "For flashcards it's important to write the flashcardsjson type",
    requirements: [],
  },
  game: {
    template:
...
\`\`\``,
    description:
      "For presentation content it's important to write the presentation type",
    requirements: [
...
export const isWebResultJson = (
  format: BaseFormat,
): format is WebResultJson => {
  return format.type === "webresult";
};

export const isFlashcardsJson = (
  format: BaseFormat,
): format is FlashcardsJson => {
...
export const isPresentationJson = (
  format: BaseFormat,
): format is PresentationJson => {
