      ...
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-8 xl:col-span-1">
            ...
            <div class="flex space-x-6">
              <a
                href="https://twitter.com/laion_ai"
            ...
            <div class="md:grid md:grid-cols-2 md:gap-8">
                ...
                <ul class="mt-4 space-y-4">
                  <li>
                    <a
                      ...
                      class="text-base text-primary-100 hover:text-white"
                    >
                      {lang === "de" ? "Blog" : "Blog"}
                    </a>
                  </li>
              ...
              <div class="mt-12 md:mt-0">
                ...
                <ul class="mt-4 space-y-4">
                  <li>
                    <a
                      href="https://laion.ai/privacy-policy"
                      class="text-base text-primary-100 hover:text-white"
                    >
        ...
        <div class="mt-12 border-t border-primary-500 pt-8">
          <p class="text-base text-primary-100 xl:text-center">
            Generated on 07.03.2025. Prompted with love by{" "}
            <a
              href="https://github.com/laion-ai"
