...
export function FormatExtractionExample() {
  ...
  const renderFormatSelector = () => (
    <div class="format-selector mb-4">
      ...
      <select 
        id="format-type"
        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-primary-500"
        value={formatType}
    ...
    <div class="format-extraction-example max-w-3xl mx-auto p-4">
      ...
      <form onSubmit={handleSubmit} class="mb-6">
        ...
        <button
          ...
          class="w-full bg-primary-600 text-white py-2 px-4 rounded-md hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50"
        >
