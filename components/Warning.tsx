...
function Warning({ lang }: { lang: string }) {
  ...
  const [isHidden, setIsHidden] = useState(
    (localStorage.getItem("warning") || "true") === "true",
  );
  ...
  return (
    ...
    >
      ...
      <div
        class={`px-4 pb-4 overflow-hidden transition-[max-height] duration-300 ease-in-out ${
      ...
      >
        ...
        <p
          ...
          dangerouslySetInnerHTML={{
            __html: formatBoldTextWhereDoubleAsterisk(
              warningContent[lang]["usage"],
            ),
          }}
        />
      </div>
